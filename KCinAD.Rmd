...
diffex <- FindMarkers(roj_rds, group.by = "svm_added_anno", ident.1 = "Basal III ASS1+")
diffex <- FindMarkers(roj_rds, group.by = "svm_added_anno", ident.1 = "Basal I")
diffex <- FindMarkers(roj_rds, group.by = "svm_added_anno", ident.1 = "Basal II")
diffex <- FindMarkers(roj_rds, group.by = "svm_added_anno", ident.1 = "Basal IV")
```
