...
BiocManager::install("org.Hs.eg.db") #update none
```
...
diff_exp_hc <- FindMarkers(basal3_dake_hc, group.by = "b3_subanno", logfc.threshold = 0, ident.1 = "Basal III KRT15+", ident.2 = "Basal III ASS1+")
...
hc <- diff_exp_hc[diff_exp_hc$p_val_adj < 0.05, ]
hc["gene"] <- rownames(hc)
